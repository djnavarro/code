...
card(
  title = "ertte", 
  text = "Work in progress package that provides a convenience layer for exposure-response time-to-event models", 
  buttons = list(
...
card(
  title = "erplots", 
  text = "Work in progress package that provides a model agnostic plotting framework for exposure-response plots", 
  buttons = list(
...
card(
  title = "erglm", 
  text = "A small package to provide a convenience layer for exposure-response models that fall within the generalized linear model, and hooks into the erplots package", 
  buttons = list(
...
card(
  title = "emaxnls", 
  text = "A lightweight tool for Emax regression models in R, providing support for exposure-response analyses using this framework, and hooks into the erplots package for visualising results", 
  buttons = list(
...
card(
  title = "lsr", 
  text = "The first R package I ever wrote, designed to suport a [statistics textbook](https://learningstatisticswithr.com/) that is a little outdated. Surprisingly it all still seems to work as intended. So that's something.", 
  buttons = list(
