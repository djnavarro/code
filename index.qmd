...
card(
  title = "erlr", 
  text = "Work in progress package that provides tools for exposure-response logistic regression analyses", 
  buttons = list(
    button("https://erlr.djnavarro.net/", "docs"),
    button("https://github.com/djnavarro/erlr", "repo")
  ),
  image = image(
    src = "img/erlr.png", 
    url = "https://erlr.djnavarro.net/",
