...
card(
  title = "lsr", 
  text = "The first R package I ever wrote, designed to suport a [statistics textbook](https://learningstatisticswithr.com/) that a little outdated. Surprisingly it all still seems to work as intended. So that's something.", 
  buttons = list(
