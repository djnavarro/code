...
card(
  title = "erglm", 
  text = "Work in progress package that provides a convenience layer for exposure-response models that fall within the generalized linear model", 
  buttons = list(
...
card(
  title = "emaxnls", 
  text = "Inspired by the BayesERtools and rstanemax packages I've worked on with Kenta Yoshida, I started thinking about what a lightweight frequentist (yes, frequentist. sue me) tool for Emax regression in R would look like. This was what happened.", 
  buttons = list(
